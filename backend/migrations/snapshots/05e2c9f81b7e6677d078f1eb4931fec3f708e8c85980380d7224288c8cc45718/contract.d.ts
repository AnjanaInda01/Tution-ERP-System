...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Class: {
      ...
      readonly teacherPercentage: CodecTypes['pg/numeric@1']['output'];
      readonly institutePercentage: CodecTypes['pg/numeric@1']['output'];
    ...
    readonly Invoice: {
      ...
      readonly billingYear: CodecTypes['pg/int4@1']['output'];
      readonly billingMonth: CodecTypes['pg/int4@1']['output'];
      readonly amount: CodecTypes['pg/numeric@1']['output'];
      readonly teacherPercentage: CodecTypes['pg/numeric@1']['output'];
      readonly institutePercentage: CodecTypes['pg/numeric@1']['output'];
      readonly status: 'pending' | 'partially_paid' | 'paid' | 'cancelled' | 'overdue';
    ...
    readonly Payment: {
      ...
      readonly teacherPercentage: CodecTypes['pg/numeric@1']['output'];
      readonly institutePercentage: CodecTypes['pg/numeric@1']['output'];
      readonly teacherAmount: CodecTypes['pg/numeric@1']['output'];
      readonly instituteAmount: CodecTypes['pg/numeric@1']['output'];
      readonly method: 'cash' | 'bank_transfer' | 'online';
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Class: {
      ...
      readonly teacherPercentage: CodecTypes['pg/numeric@1']['input'];
      readonly institutePercentage: CodecTypes['pg/numeric@1']['input'];
      readonly deliveryMode: 'physical' | 'online' | 'hybrid';
      readonly status: 'draft' | 'active' | 'completed' | 'cancelled' | 'archived';
    ...
    readonly Invoice: {
      ...
      readonly billingYear: CodecTypes['pg/int4@1']['input'];
      readonly billingMonth: CodecTypes['pg/int4@1']['input'];
    ...
    readonly Payment: {
      ...
      readonly teacherPercentage: CodecTypes['pg/numeric@1']['input'];
      readonly institutePercentage: CodecTypes['pg/numeric@1']['input'];
      readonly teacherAmount: CodecTypes['pg/numeric@1']['input'];
      readonly instituteAmount: CodecTypes['pg/numeric@1']['input'];
      readonly method: 'cash' | 'bank_transfer' | 'online';
      readonly status: 'pending' | 'completed' | 'failed' | 'refunded';
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly class: {
              columns: {
                ...
                readonly teacherPercentage: {
                  readonly nativeType: 'numeric';
                  readonly codecId: 'pg/numeric@1';
                  readonly nullable: false;
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/numeric@1', '80'>;
                  };
                };
                readonly institutePercentage: {
                  readonly nativeType: 'numeric';
                  readonly codecId: 'pg/numeric@1';
                  readonly nullable: false;
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/numeric@1', '20'>;
                  };
                };
            ...
            readonly invoice: {
              ...
              uniques: readonly [
                { readonly columns: readonly ['id', 'instituteId'] },
                { readonly columns: readonly ['enrollmentId', 'billingYear', 'billingMonth'] },
              ];
              indexes: readonly [
                {
                  readonly name: 'invoice_instituteId_status_idx_b5328fd7';
                  readonly prefix: 'invoice_instituteId_status_idx';
                  readonly columns: readonly ['instituteId', 'status'];
                  readonly unique: false;
                },
                {
                  readonly name: 'invoice_instituteId_studentId_idx_aedbc27b';
                  readonly prefix: 'invoice_instituteId_studentId_idx';
                  readonly columns: readonly ['instituteId', 'studentId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'invoice_instituteId_enrollmentId_idx_78805778';
                  readonly prefix: 'invoice_instituteId_enrollmentId_idx';
                  readonly columns: readonly ['instituteId', 'enrollmentId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'invoice_instituteId_billingYear_billingMonth_idx_ed325102';
                  readonly prefix: 'invoice_instituteId_billingYear_billingMonth_idx';
                  readonly columns: readonly ['instituteId', 'billingYear', 'billingMonth'];
                  readonly unique: false;
                },
                {
                  readonly name: 'invoice_studentId_instituteId_idx_77a018a9';
                  readonly prefix: 'invoice_studentId_instituteId_idx';
                  readonly columns: readonly ['studentId', 'instituteId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'invoice_enrollmentId_instituteId_idx_01dade96';
                  readonly prefix: 'invoice_enrollmentId_instituteId_idx';
                  readonly columns: readonly ['enrollmentId', 'instituteId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
            ...
            readonly payment: {
              columns: {
                ...
                readonly teacherAmount: {
                  readonly nativeType: 'numeric';
                  readonly codecId: 'pg/numeric@1';
                  readonly nullable: false;
                };
                readonly instituteAmount: {
                  readonly nativeType: 'numeric';
                  readonly codecId: 'pg/numeric@1';
                  readonly nullable: false;
                };
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['id', 'instituteId'] }];
              indexes: readonly [
                {
                  readonly name: 'payment_instituteId_invoiceId_idx_8eb6f346';
                  readonly prefix: 'payment_instituteId_invoiceId_idx';
                  readonly columns: readonly ['instituteId', 'invoiceId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'payment_instituteId_studentId_idx_aedbc27b';
                  readonly prefix: 'payment_instituteId_studentId_idx';
                  readonly columns: readonly ['instituteId', 'studentId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'payment_instituteId_enrollmentId_idx_78805778';
                  readonly prefix: 'payment_instituteId_enrollmentId_idx';
                  readonly columns: readonly ['instituteId', 'enrollmentId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'payment_instituteId_status_idx_b5328fd7';
                  readonly prefix: 'payment_instituteId_status_idx';
                  readonly columns: readonly ['instituteId', 'status'];
                  readonly unique: false;
                },
                {
                  readonly name: 'payment_instituteId_paymentDate_idx_9f2427e7';
                  readonly prefix: 'payment_instituteId_paymentDate_idx';
                  readonly columns: readonly ['instituteId', 'paymentDate'];
                  readonly unique: false;
                },
                {
                  readonly name: 'payment_invoiceId_instituteId_idx_1e502765';
                  readonly prefix: 'payment_invoiceId_instituteId_idx';
                  readonly columns: readonly ['invoiceId', 'instituteId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'payment_studentId_instituteId_idx_77a018a9';
                  readonly prefix: 'payment_studentId_instituteId_idx';
                  readonly columns: readonly ['studentId', 'instituteId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'payment_enrollmentId_instituteId_idx_01dade96';
                  readonly prefix: 'payment_enrollmentId_instituteId_idx';
                  readonly columns: readonly ['enrollmentId', 'instituteId'];
                  readonly unique: false;
                },
              ];
          ...
          readonly valueSet: {
            ...
            readonly payment_method: {
              readonly kind: 'valueSet';
              readonly values: readonly ['cash', 'bank_transfer', 'online'];
            };
          ...
          readonly Class: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly teacherPercentage: { readonly column: 'teacherPercentage' };
                readonly institutePercentage: { readonly column: 'institutePercentage' };
            ...
            readonly relations: {
              ...
              readonly invoices: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['enrollmentId', 'instituteId'];
                };
              };
              readonly payments: {
                readonly to: {
          ...
          readonly Invoice: {
            ...
            readonly relations: {
              readonly enrollment: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['enrollmentId', 'instituteId'];
                  readonly targetFields: readonly ['id', 'instituteId'];
                };
              };
              readonly payments: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id', 'instituteId'];
                  readonly targetFields: readonly ['invoiceId', 'instituteId'];
                };
              };
              readonly student: {
                readonly to: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly billingYear: { readonly column: 'billingYear' };
                readonly billingMonth: { readonly column: 'billingMonth' };
          ...
          readonly Payment: {
            ...
            readonly relations: {
              ...
              readonly invoice: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['invoiceId', 'instituteId'];
                  readonly targetFields: readonly ['id', 'instituteId'];
                };
              };
              readonly student: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly teacherPercentage: { readonly column: 'teacherPercentage' };
                readonly institutePercentage: { readonly column: 'institutePercentage' };
                readonly teacherAmount: { readonly column: 'teacherAmount' };
                readonly instituteAmount: { readonly column: 'instituteAmount' };
